      ...
      <div
        ...
        <div>
          <h1 className={`${styles.sectionHeadText}`}>
            Hi, I'm <span className="text-[#915eff]">Sohad</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I'm a dedicated front-end developer with a proven ability to adapt
            to self-starting environments and collaborate effectively with other
            developers.
          </p>
        </div>
      </div>
